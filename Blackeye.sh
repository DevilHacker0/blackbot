#!/bin/bash
# BLACKEYE v1.0 is an upgrade from original ShellPhish Tool (https://github.com/DevilHacker0/shellphish) by DevilHacker0 under GNU LICENSE 
# Coded by: @DevilHacker0 (https://github.com/DevilHacker0/blackbot)
# Upgraded by: @DevilHacker0 (https://github.com/DevilHacker0/blackbot)
